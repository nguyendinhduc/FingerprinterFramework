...
public class TrackingRecord extends UpdatableRecordImpl<TrackingRecord> implements Record6<Integer, Integer, Integer, Time, Integer, Integer> {

    private static final long serialVersionUID = 679353162;
    ...
    /**
     * Setter for <code>public.tracking.user_id</code>.
     */
    ...
    /**
     * Getter for <code>public.tracking.user_id</code>.
     */
     ...
     */
    @Override
    public Row6<Integer, Integer, Integer, Time, Integer, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row6<Integer, Integer, Integer, Time, Integer, Integer> valuesRow() {
     ...
     */
    @Override
    public TrackingRecord value4(Time value) {
     ...
     */
    @Override
    public TrackingRecord values(Integer value1, Integer value2, Integer value3, Time value4, Integer value5, Integer value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TrackingRecord(Integer id, Integer x, Integer y, Time createdTime, Integer roomId, Integer userId) {
        super(Tracking.TRACKING);
