...
public class FingerprinterInfoDetail extends TableImpl<FingerprinterInfoDetailRecord> {
    ...
    private static final long serialVersionUID = 1884985794;
     ...
     */
    public final TableField<FingerprinterInfoDetailRecord, TypeFingerprinterInfo> TYPE = createField("type", org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "", new TypeFingerprinterInfoConvertter());
