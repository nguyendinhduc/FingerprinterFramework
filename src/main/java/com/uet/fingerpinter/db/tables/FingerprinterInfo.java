...
public class FingerprinterInfo extends TableImpl<FingerprinterInfoRecord> {
    ...
    private static final long serialVersionUID = 1865689287;
     ...
     */
    public final TableField<FingerprinterInfoRecord, String> AP_NAME = createField("ap_name", org.jooq.impl.SQLDataType.VARCHAR.length(1000).nullable(false), this, "");

    /**
     * The column <code>location_indoor.fingerprinter_info.mac_address</code>.
     */
    public final TableField<FingerprinterInfoRecord, String> MAC_ADDRESS = createField("mac_address", org.jooq.impl.SQLDataType.VARCHAR.length(1000).nullable(false), this, "");
