...
public class FingerprinterInfo extends TableImpl<FingerprinterInfoRecord> {
    ...
    private static final long serialVersionUID = 1422789221;

    /**
     * The reference instance of <code>public.fingerprinter_info</code>
     */
    ...
    /**
     * The column <code>public.fingerprinter_info.id</code>.
     */
    public final TableField<FingerprinterInfoRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('fingerprinter_info_id_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>public.fingerprinter_info.ap_name</code>.
     */
    ...
    /**
     * The column <code>public.fingerprinter_info.mac_address</code>.
     */
    ...
    /**
     * The column <code>public.fingerprinter_info.rss</code>.
     */
    public final TableField<FingerprinterInfoRecord, Double> RSS = createField("rss", org.jooq.impl.SQLDataType.DOUBLE.nullable(false), this, "");

    /**
     * The column <code>public.fingerprinter_info.x</code>.
     */
    ...
    /**
     * The column <code>public.fingerprinter_info.y</code>.
     */
    ...
    /**
     * The column <code>public.fingerprinter_info.room_id</code>.
     */
    ...
    /**
     * The column <code>public.fingerprinter_info.building_id</code>.
     */
    ...
    /**
     * Create a <code>public.fingerprinter_info</code> table reference
     */
    ...
    /**
     * Create an aliased <code>public.fingerprinter_info</code> table reference
     */
    ...
    public UniqueKey<FingerprinterInfoRecord> getPrimaryKey() {
        return Keys.FINGERPRINTER_INFO_PKEY;
    }
    ...
    public List<UniqueKey<FingerprinterInfoRecord>> getKeys() {
        return Arrays.<UniqueKey<FingerprinterInfoRecord>>asList(Keys.FINGERPRINTER_INFO_PKEY);
    }
    ...
    public List<ForeignKey<FingerprinterInfoRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<FingerprinterInfoRecord, ?>>asList(Keys.FINGERPRINTER_INFO__FORKEY_1, Keys.FINGERPRINTER_INFO__FORKEY_2);
    }
